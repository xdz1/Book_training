package org.xdz.booktrain.book.servlet;
 ...
 *
 */
public class BookServlet extends BaseServlet implements Servlet {
...
private CategoryService categoryService = new CategoryService() ;
	...
	public String findByCombination(HttpServletRequest req, HttpServletResponse resp)
		...
		Book criteria = CommonUtils.toBean(map, Book.class);
	 ...
	 * @throws IOException
	 */
	public String ajaxFindNewBook(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String status = req.getParameter("status");
		String num = req.getParameter("num");
		List<Book> booklist = bookService.findByStatus(status,num);
	 ...
	 * @throws IOException
	 */
	public String ajaxFindHotBook(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String status = req.getParameter("status");
		String num = req.getParameter("num");
		List<Book> booklist = bookService.findByStatus(status,num);
