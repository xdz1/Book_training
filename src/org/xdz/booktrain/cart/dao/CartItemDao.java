package org.xdz.booktrain.cart.dao;
...
public class CartItemDao {
	 ...
	 * @throws SQLException 
	 */
	public int statisticsTotal(String uid) throws SQLException {
		String sql = "SELECT COUNT(*) FROM t_cartitem WHERE uid = ?";
		Number query = (Number) qr.query(sql, new ScalarHandler(),uid);
		return query.intValue();
	}
	
	/**
	 * 根据传过来的数组长度生成where Sql语句
	 * @param len
	 * @return
	 */
